...
<body>
    <div class="container">
        <a href="index.php" class="back-btn"><i class='bx bx-arrow-back'></i></a>
        ...
        <div class="form-box register">
            <form action="process_user_signup.php" method="post">
                ...
                <button type="submit" class="btn" name="signup_submit">Register</button>
        ...
        <div class="toggle-box">
            <div class="toggle-panel toggle-left">
                ...
                <a class="manager_click" href="manage_login.php">Click Here If You're A Manager</a>
            </div>
